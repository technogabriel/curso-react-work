...
export const Home = () => {
  ...
  return (
    <>
      <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-white border-slate-200 shadow-slate-950/5 max-w-xs items-center justify-center mx-auto my-4">
