...
const Spinner = () => {
    return (
        <div className="flex justify-center items-center h-screen ">
            <svg fill="none" className="h-6 w-6 animate-spin text-surface" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
